...
SELECT id_dep, nomedep, parentesco
FROM dependente 
WHERE id_dep = 6
...
id_func																	id_superv   id_depto
  2	  "Frank T. Santos"	  "R. Gentios, 22"	  "1966-02-02"	  "M" 1000.00	8			1
...
SELECT * FROM funcionario  
WHERE id_depto = 1 and id_func!=2
...
SELECT * FROM departamento --- id_depto = 1
SELECT * FROM projeto --- id_proj = 30
SELECT * FROM trabalha 
SELECT * FROM funcionario
